...
type MapMarkerProps = {
  ...
  /** Additional CSS classes for the root marker element */
  className?: string;
...
type MapControlsProps = {
  ...
  showLocate?: boolean;
  /** Show tilt toggle button for 3D view (default: false) */
  showTilt?: boolean;
...
function MapControls({
  ...
  return (
    ...
    >
      ...
      {showTilt && (
        <ControlGroup>
          <ControlButton onClick={handleToggleTilt} label="Toggle 3D Tilt">
